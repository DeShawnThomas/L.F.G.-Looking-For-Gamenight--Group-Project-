...
class User:
    ...
    @classmethod
    def save(cls,data):
        query = "INSERT INTO users (first_name,last_name,email,phone_number,password,can_host,user_location,user_description) VALUES(%(first_name)s,%(last_name)s,%(email)s,%(phone_number)s,%(password)s,%(can_host)s,%(user_location)s,%(user_description)s)"
